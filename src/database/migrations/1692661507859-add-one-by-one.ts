...
export class AddOneByOne1692661507859 implements MigrationInterface {
    name = 'AddOneByOne1692661507859'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_c6c520dfb9a4d6dd749e73b13d\` ON \`users\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`brands\` CHANGE \`updatedAt\` \`updatedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`brands\` CHANGE \`createdAt\` \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_c6c520dfb9a4d6dd749e73b13d\` ON \`users\` (\`customerId\`)`);
    }
